...
const HomePage = () => {
  ...
  useEffect(() => {
    const getAllTransection = async () => {
      try {
        ...
        setLoading(true);
        const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/v1/transection/get-transection`, {
          userid: user._id,
          frequency,
          selectedDate,
          type,
  ...
  const handleDelete = async (record) => {
    try {
      setLoading(true);
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/v1/transection/delete-transection`, {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (editable) {
        ...
        await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/v1/transection/add-transection`, {
          ...values,
          userid: user._id,
        });
        setLoading(false);
